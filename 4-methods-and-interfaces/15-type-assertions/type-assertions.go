...
// This statement asserts that the interface value i holds the conrete type T and assigns the underlying T value to
// the variable t.
...
// If not, ok will be false and t will be the zero value of type T, and no panic occers.
